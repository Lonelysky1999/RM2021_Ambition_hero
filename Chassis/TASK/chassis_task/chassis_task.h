...
#define CHASSIS_ANGLE_Z_RC_SEN 0.000007f	//def 0.000002f
...
//底盘运动过程普通前进速度
#define NORMAL_NAL_CHASSIS_SPEED_X 1.2f//1.2f
//底盘运动过程普通平移速度
#define NORMAL_NAL_CHASSIS_SPEED_Y 0.8f//0.8f
...
#define M3505_MOTOR_SPEED_PID_KI 15.0f
...
typedef struct
{
  const chassis_rx_data_t *chrx_data; 
